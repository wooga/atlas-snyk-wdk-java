...
class JavaSnykPluginConventionsPluginSpec extends ProjectSpec {

    public static final String PLUGIN_NAME = 'net.wooga.snyk-wdk-java'
    public static final String EXTENSION_NAME = "snykJava"
    ...
    def 'Creates needed tasks'(String taskName, Class taskType) {
        ...
        where:
        taskName  | taskType
        "example" | JavaSnykPluginConventions
    }
    ...
    def 'Creates the [#extensionName] extension with type #extensionType'() {
        ...
        EXTENSION_NAME | JavaSnykPluginConventionsPluginExtension
    }
